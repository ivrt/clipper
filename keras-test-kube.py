...
clipper_conn = ClipperConnection(KubernetesContainerManager(
    ...
    # redis_ip='pactly-clipper-redis.lw3tnf.0001.apse1.cache.amazonaws.com',
    # redis_port=
    ))
...
for file in os.listdir('models'):
    ...
    if file_ext == "h5":
        ...
        keras_deployer.deploy_keras_model(clipper_conn=clipper_conn,
            ...
            pkgs_to_install=['boto3'],
            registry="538473993190.dkr.ecr.ap-southeast-1.amazonaws.com",
